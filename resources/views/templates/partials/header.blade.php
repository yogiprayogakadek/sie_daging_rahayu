                ...
                <li>
                    <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                        <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button"
                            ...
                            <img class="avatar img-thumbnail rounded-circle shadow" src="{{asset('assets/uploads/images/users/default.png')}}"
                                alt="" />
                        </a>
                        <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                            <div class="card border-0 w240">
                                <div class="card-body border-bottom d-flex">
                                    <img class="avatar rounded-circle" src="{{asset('assets/uploads/images/users/default.png')}}" alt="" />
                                    <div class="flex-fill ms-3">
                                        ...
                                        <span class="text-muted"><a
                                                ...
                                                class="__cf_email__"
                                                data-cfemail="92f3fefefbf7f5e0f3e6f7e0d2fee7fcfdbcf1fdff">[email&#160;protected]</a></span>
                                    </div>
                                </div>
